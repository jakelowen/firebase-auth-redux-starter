...
test('record user details', () => {
  ...
  expect(state).toEqual({ auth: { authenticated: false, error: null, uid: null, profile: { uid: 'DgJDJLETXIPdMcecU6g8DmUm3Ku1', firstName: 'Jake', lastName: 'Lowen', email: 'jake@gpsimpact.com' } } });
});
